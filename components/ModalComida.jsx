													...
													<MDBCard style={{ backgroundColor: "#191919" }}>
														...
														<MDBCardBody>
															...
															<MDBCardText className="text-white fs-5">
																Okonomiyaki é uma receita japonesa, se parece
																com crepe ou até mesmo uma pizza. Esse prato
												...
												<MDBCol>
													<MDBCard style={{ backgroundColor: "#191919" }}>
														...
														<MDBCardBody>
															...
															<MDBCardText className="text-white fs-5">
																Uramaki é um prato tipico do Japão, se trata de
																um sushi enrolado em arroz.
															</MDBCardText>
														</MDBCardBody>
														<MDBCardFooter>
															<h4 className="text-danger">R$ 25,00</h4>
